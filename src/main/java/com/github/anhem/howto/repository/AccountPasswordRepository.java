...
public class AccountPasswordRepository extends JdbcRepository {
    ...
    private static final String SELECT_PASSWORD = "SELECT * FROM account_password WHERE account_id = :id";
    ...
    public AccountPassword getPassword(AccountId accountId) {
        return findById(accountId, SELECT_PASSWORD, (rs, i) -> mapToAccountPassword(rs));
    }
